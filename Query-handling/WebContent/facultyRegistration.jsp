...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
        <link rel="stylesheet" type="text/css" href="facultyreg.css">
...
body{
    background-image: url("https://ak4.picdn.net/shutterstock/videos/5669444/thumb/1.jpg");
        ...
        <div class = "container">          
            <div class = "row">
                ...
                <div class = "col-md-6">
                    ...
                    <form name="myForm" onsubmit="return formValidate()" action="admin/registerFaculty1" method="POST"> 
                    ...
                    <div class = "col-md-9">
                        <input type = "text" class = "form-control" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="Enter valid email">
                    </div>
                    ...
                    <div class = "col-md-9">
                        <input type = "Password" minlength=6 maxlength=15 pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 6 or more characters"  class = "form-control" name="password" placeholder = "Enter password">
